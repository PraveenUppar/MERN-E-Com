...
export default function LoginPage() {
  ...
  // useRegisterMutation are hooks generated by RTK Query
  // register: This is a function you can call to actually trigger the register API request.
  const [register, { isLoading }] = useRegisterMutation();

  // handleRegister function
  const handleRegister = async (e) => {
    e.preventDefault();
    // checks if both the password and confirm password match
    if (password !== confirmPassword) {
      alert("Passwords do not match");
    } else {
      // it sends name email and password as arguments to the frontend redux hook query useRegisterMutation --> register
      try {
        const res = await register({ name, email, password }).unwrap();
        // on successfull registeration it dispastches the response form the backend to the setCredentials which stores it in local storage
